<?php
/*
	执行Action的行为  api_root_add_stock.php 对应老的 mlm中的php是什么？
*/
api_root_add_stock($api_object);
...
function api_root_add_stock($api_obj) {

		
	$sp_sql	= "select * from ez_marketing_db.sp_mlm_n_cmd_stock_recharge($1,$2,$3,$4,$5,$6)";

	if(empty($api_obj->params['api_params']['pv']))
		$api_obj->params['api_params']['pv'] = '0';
	$mlm_params = array(
						$api_obj->params['api_params']['bsn'], 
						$api_obj->params['api_params']['imei'], 
						$api_obj->params['api_params']['pno'],
						$api_obj->params['api_params']['pass'],
						$api_obj->params['api_params']['uid'],
						$api_obj->params['api_params']['pv']						
						);
