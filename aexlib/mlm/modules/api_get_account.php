...
function api_get_account($api_obj) {
	//require_once ($p_params['common-path'].'/api_pgsql_db.php');
	
	$sp_sql	= "select * from ez_marketing_db.sp_mlm_n_cmd_account_info($1,$2,$3,$4) ";
	...
	if(is_array($mlm_return)){
		if($api_obj->return_code > 0)
		{
			...
			$api_obj->push_return_data('USERID',$mlm_return['v_user_id']);
