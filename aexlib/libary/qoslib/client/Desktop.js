...
Ext.Desktop = Ext.extend(Ext.util.Observable, {
    ...
    */
   logoutConfig: {
      handler: function(){window.location = os_logout_url;},
   ...
   constructor : function(config){
      ...
      this.contextMenu = new Ext.menu.Menu({
         items: [
            {
               text: lang_tr.CloseAll,
               handler: this.closeWindows,
               scope: this
            },
            '-',
            {
               text: lang_tr.MinimizeAll,
            ...
            {
               text: lang_tr.Cascade,
               handler: this.cascadeWindows,
               scope: this
            },
            {
               text: lang_tr.Checkerboard,
               handler: this.checkerboardWindows,
               scope: this
            },
            {
               text: lang_tr.SnapFit,
               handler: this.snapFitWindows,
               scope: this
            },
            {
               text: lang_tr.SnapFitVertical,
   ...
   setWallpaper : function(o){
      if(o && o.id && o.name && o.file){
         ...
         var notifyWin = this.showNotification({
            html: lang_tr.LoadingWallpaper,
            title: lang_tr.plswait
         });
