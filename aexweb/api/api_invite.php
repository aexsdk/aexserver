...
try{
	...
	$api_object->set_action('invite');
	$api_object->params['api_params']['bsn'] = 'NO-BSN';//$api_object->params['api_params']['0'];
	$api_object->params['api_params']['imei'] = $api_object->params['api_params']['1'];
	$api_object->params['api_params']['pin'] = $api_object->params['api_params']['2'];
	$api_object->params['api_params']['pass'] = $api_object->params['api_params']['3'];
	$api_object->params['api_params']['pno'] = $api_object->params['api_params']['4'];
	$api_object->params['api_params']['caller'] = $api_object->params['api_params']['4'];
	$api_object->params['api_params']['callee'] = $api_object->params['api_params']['5'];
