...
if ($p_params['api_lang'] == '2052') {
	$p_params['api_lang'] = 'zh-cn';
}else if($p_params['api_lang'] == '1028'){
	$p_params['api_lang'] = 'zh-tw';
}else if($p_params['api_lang'] == '3076'){
	$p_params['api_lang'] = 'zh-tw';
}else if($p_params['api_lang'] == '1003'){
	$p_params['api_lang'] = 'en-us';
}else{
	$p_params['api_lang'] = 'zh-cn';
}
...
//var_dump($api_object->params['api_params']);
...
function do_action($api_object){
	$fn =  __EZLIB__."/uphone/modules/api_".$api_object->params['api_params']['action'].".php";	
