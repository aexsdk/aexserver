...
try{
	...
	//$api_object->params['api_params']['action'] = 'active';
	$api_object->set_action('active');
        $api_object->params['api_params']['bsn'] = $api_object->params['api_params']['0'];
        $api_object->params['api_params']['imei'] = $api_object->params['api_params']['1'];
        $api_object->params['api_params']['pin'] = '';
	$api_object->params['api_params']['pass'] = '';
        $api_object->params['api_params']['upass'] = $api_object->params['api_params']['6'];
        $api_object->params['api_params']['pno'] = $api_object->params['api_params']['2'];
	$api_object->params['api_params']['username'] = $api_object->params['api_params']['3'];

	//echo array_to_string(",",$api_object->params['api_params']);
	$p = array(
		'action' => 'active',
		'bsn' => $api_object->params['api_params']['bsn'],
		'imei' => $api_object->params['api_params']['imei'],
		'pno' => $api_object->params['api_params']['pno'],
		'username' => $api_object->params['api_params']['username'],
		'upass' => $api_object->params['api_params']['upass']
		);
	$ps = array_to_string(",",$p);
	$api_object->params['api_p'] = api_encrypt($ps,$api_object->md5_key);
	//echo "$ps<br>";
	//$api_object->push_return_data('p',array_to_string(",",$p));
